...
export default function Banner({ data }) {
    return (
        <>
            <section>
                <CustomCountainer>
                    <div className="xl:h-[78vh] md:h-[63vh] h-[52vh] rounded-4xl overflow-hidden">
                        <Swiper
                            effect={"fade"}
                                ...
                                <SwiperSlide key={item.id}>
                                    <div className="Banner relative h-[82vh]">
                                        <div className="Banner-overlay absolute top-0 left-0 w-full h-full xl:px-8 xl:py-4 md:px-7 md:py-3 px-6 py-2">
                                            <h2 className="xl:text-4xl md:text-3xl text-xl font-medium xl:mb-4 md:mb-3 mb-2 text-amber-700">{item.title}</h2>
