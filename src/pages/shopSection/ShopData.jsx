        ...
        <>
            <section>
                <div className="shop-data relative h-[50vh] rounded-2xl overflow-hidden bg-red-800 mt-4 group">
                    <button className="absolute cursor-pointer px-3.5 py-1.5 top-4 left-3 bg-zinc-200 text-blue-700 z-10 rounded-3xl" onClick={() => setOpen(true)}>
                        Buying
                    </button>
                    ...
                    <div className="shop-data top-0 absolute left-0 w-full h-full flex justify-end flex-col bg-[rgba(0,0,0,.2)]">
                        <div
                            ...
                            {inWishList(item.id) ? <FaHeart className="text text-green-600" /> : <FaHeart className="text-white" />}
                        </div>
                ...
                <div className="fixed top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.6)] flex items-center justify-center z-15">
                    <div className="bg-white p-7 rounded-2xl w-[80%] max-w-2xl relative">
                        ...
                        <div className="flex gap-15">
                            ...
                            <div className="border border-e-gray-500 px-2.5 py-1.5 mt-0.5 w-[6.6em]">
                                <p className="text-gray-600">Counter : {counter}</p>
                                <div className="ml-[1em] flex gap-2 justify-between w-[3em]">
                                    <button className="text-xl cursor-pointer" onClick={increaseCounter}>
                                        +
                                    </button>
                                    <button className="text-xl cursor-pointer" onClick={decreaseCounter}>
                                        -
                                    </button>
                                </div>
                            </div>
